...
import TelegramButtonCreateForm from './ButtonCreateForms/TelegramButtonCreateForm'

export default function TelegramOptionsBlock(props:any) {
...
// console.log(channelInfo)
  return (
    <div className={styles.buttonsForm}>
        <div className={styles.header}><h1>Telegram</h1></div>
      ...
      <TelegramButtonCreateForm butAmount={buttonsState.length} isInline={keyR} create={createButton}/>
      <Table striped>
      <thead>
        <tr>
          <th>Текст</th>
